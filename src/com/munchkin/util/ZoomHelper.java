...
public class ZoomHelper {
	...
	public static void zoomImageFromThumb(final View thumbView, int imageResId,
			Activity a) {
		...
		// expandedImageView.setLayoutParams(new
		// LayoutParams((int)(MunchkinUtil.getScreenHeight(a)*.71),MunchkinUtil.getScreenHeight(a)));
